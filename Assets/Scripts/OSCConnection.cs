...
public class OSCConnection : MonoBehaviour {
	...
	public int ListenerPort = 12000; //the port you will be listening on
	...
	public void AllMessageHandler(OscMessage oscMessage ){
		...
		Debug.Log("msgString: " + msgString); //log the message and values coming from OSC
		...
		foreach( OSCAnimation animator in scriptsToCall ) {
			...
			if ( animator.messageAddress.Equals( msgAddress )) {
				...
				//animator.Animate (msgString); Scott wrote this BS
				sentMessage = true;
			}
